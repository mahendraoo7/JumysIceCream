...
const Login = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex justify-center items-center gap-10 w-full px-6 md:px-10 lg:px-20 py-10">
        {/* Login Form */}
        <div className="p-6 bg-white border border-black w-full lg:w-1/2">
          ...
          <div className='flex justify-end my-5'>
            <h1 className='font-medium '> You don't have account
               <NavLink to="/register">
                  <button className='underline font-bold text-[18px] hover:text-blue-950'> Register Now </button>
               </NavLink>
              </h1>
          </div>
        </div>
