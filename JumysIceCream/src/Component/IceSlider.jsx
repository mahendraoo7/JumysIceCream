...
const IceSlider = () => {
  return (
    <div className="grid grid-cols-4 gap-5 ">
      {/* 1st card */}
      <div className=" bg-[#dff6e8] mb-20 shadow-md p-6 text-center max-w-xs mx-auto h-[500px]">
        <div
          className="w-44 h-44 border hover:scale-105 duration-1000  mx-auto rounded-full overflow-hidden mb-4 font-Kalnia"
